...
func main() {
	...
	if !rootNodeAvailable {
		fmt.Println("Enter the root role name:")
		fmt.Scan(&roolName)
		fmt.Println("Root Role : ", roolName)
...
func operations() int {
	...
	fmt.Println("8. No of the Users from Top")
	fmt.Println("9. Height of the Role Hierarchy")
	fmt.Println("10. Common Boss of the User")
	fmt.Println("11. EXIT")
